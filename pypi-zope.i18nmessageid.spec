...
Source0  : https://files.pythonhosted.org/packages/59/c5/58fab4c6a5a82a8e276adcb9f42ad6cf19ace3ee48e96ef4628218638f79/zope_i18nmessageid-7.0.tar.gz
...
%prep
%setup -q -n zope_i18nmessageid-7.0
cd %{_builddir}/zope_i18nmessageid-7.0
pushd ..
cp -a zope_i18nmessageid-7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726580657
...
cp %{_builddir}/zope_i18nmessageid-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-zope.i18nmessageid/a0b53f43aab58b46bf79ba756c50771c605ab4c5 || :
